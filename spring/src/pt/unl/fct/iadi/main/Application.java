...
public class Application {
    ...
    @Bean
    public CommandLineRunner commandLineRunner(ApplicationContext ctx, UserRepository users, ArtRepository arts,
    		ReviewRepository reviews){//TaskRepository tasks) {
        return args -> {
            ...
            Review r = new Review(1, 1, new Date().getTime(), 4, "I like it.");
            reviews.save(r);
